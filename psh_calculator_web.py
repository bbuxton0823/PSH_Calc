#!/usr/bin/env python3
"""
PSH Rent Calculator - Web Version
Beautiful, responsive web interface that works on any device
"""
        ...
        <div class="content">
            ...
            <div id="results" style="display: none;" class="results">
                ...
                <div class="export-section">
                    <button class="export-button" onclick="exportExcel()">📊 Export to Excel</button>
                    <button class="export-button" onclick="printResults()">🖨️ Print Results</button>
                </div>
            </div>
        </div>
    </div>
